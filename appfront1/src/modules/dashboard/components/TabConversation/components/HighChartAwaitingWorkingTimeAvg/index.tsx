...
const HighChartAwaitingWorkingTimeAvg: FC<HighChartAwaitingWorkingTimeAvgProps & I18nProps> = ({
    filter,
    getTranslation,
    onLoading,
}) => {
                ...
                exporting: {
                    ...
                    menuItemDefinitions: {
                        ...
                        viewData: {
                            ...
                            text: showDataTable ? 'Hide data table' : 'View data table',
    ...
    const getChartOptions = async () => {
        ...
        const analytics = await DashboardService.getConversationsAnalytics(
            {
                ...
                groupBy: 'awaiting-working-time-avg',
            },
            cancelToken
        );
        onLoading(false);
        ...
        const options: Highcharts.Options = {
            title: {
                text: getTranslation('Average waiting time for service in active hours of teams'),
                x: 80,
                widthAdjust: -250,
            },
            ...
            tooltip: {
                formatter: function () {
                    return `<br />${this.x} <br /> ${getTranslation(
            ...
            series: [
                {
                    name: getTranslation('Average waiting time for service in active hours of teams'),
                    type: 'spline',
                    data: dataSeries,
                },
            ],
    ...
    useEffect(() => {
        const chartElement = document.getElementById('chart-HighChartAwaitingWorkingTimeAvg');
    ...
    const handleCsvDownload = (options) => {
        ...
        linkElement.download = `tempo-medio-espera-histograma.csv`;
    ...
    return (
        <Wrapper id='chart-HighChartAwaitingWorkingTimeAvg'>
            ...
            {chartOptions && showDataTable && (
                <Wrapper flexBox flexDirection='column'>
                    <Wrapper flexBox>
                        ...
                        <Wrapper flexBox flexDirection='column'>
                            <b>{getTranslation('Average waiting time for service in active hours of teams')}</b>
...
export interface HighChartAwaitingWorkingTimeAvgProps {
    filter: ApiConversationFilter;
    onLoading: Function;
}

export default i18n(HighChartAwaitingWorkingTimeAvg) as FC<HighChartAwaitingWorkingTimeAvgProps>;
