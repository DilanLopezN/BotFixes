...
const HighChartLine: FC<HighChartLineProps & I18nProps> = ({
    selectedPeriod,
    teams,
    getTranslation,
    onLoading,
    ...
    const getChartOptions = async () => {
        ...
        const options: Highcharts.Options = {
            ...
            yAxis: {
                ...
                labels: {
                    formatter: function () {
                        return formatYAxisValue(template.metric, this.value as number);
                    },
                },
            },
            plotOptions: {
                series: {
                    ...
                    dataLabels: {
                        ...
                        formatter: function () {
                            return formatYAxisValue(template.metric, this.y as number);
                        },
                    },
                },
            },
            ...
            tooltip: {
                formatter: function () {
                    return formatTooltip(template, this as TooltipFormatterContextObject, 'line');
                },
                shared: false,
            },
    ...
    return (
        ...
        >
            ...
            <HighchartsReact
                ...
                options={{ ...chartOptions, title: { text: template.name || getTranslation('Standard chart') } }}
                ref={chartComponent}
            />
        </Wrapper>
    );
...
export interface HighChartLineProps {
...
export default i18n(HighChartLine) as FC<HighChartLineProps>;
