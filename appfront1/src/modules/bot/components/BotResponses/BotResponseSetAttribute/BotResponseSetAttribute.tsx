...
class BotResponseSetAttributeClass extends Component<BotResponseSetAttributeProps> {
            ...
            elements: Yup.array().of(
                Yup.object().shape({
                    ...
                    name: Yup.string()
                        ...
                        .matches(
                            /^[A-Za-z0-9_-]*$/,
                            'This field must contains A-Z, a-z, 0-9, _ (underscore), - (dash). And it should start with a letter.'
                        ),
    ...
    render() {
        const elements: Array<IResponseElementSetAttribute> = this.props.response
            .elements as Array<IResponseElementSetAttribute>;
        ...
        const getInitialValues = () => {
            return defaultElements.map((elem: any) => ({
                ...elem,
                label: elem.label || '',
            }));
        };
        ...
        const typeSys = [
            ...
            SetAttributeType.cpf,
            SetAttributeType.cnpj,
                                    ...
                                    return values.elements.map((element: any, index: number) => {
                                        ...
                                        const getEntriesName = (): Array<string> => {
                                            ...
                                            if (
                                                ...
                                                entity = this.props.entitiesList.find(
                                                    (entity) => entity.name === element.type.replace('@', '')
                                                );
                                                if (entity) {
                                        ...
                                        this.props.botAttributes.map((elem) => {
                                            if (elem.type && elem.type !== '@sys.any' && elem.name === nameElement) {
                                                setAttributeDisabled = isEmpty(
                                                    typeSys.filter((ele) => ele === element.type)
                                                );
                                            }
                                        });
                                        return (
                                            <ElementWrapper key={index}>
                                                                ...
                                                                >
                                                                    <BotAttrs
                                                                        ...
                                                                        onChange={(event) => {
                                                                            ...
                                                                            value = event.value;
                                                                            const [valueCurrent] =
                                                                                this.props.botAttributes.filter(
                                                                                    (element) => {
                                                                                        if (!element || !event)
                                                                                            return null;
                                                                                        return (
                                                                                            element.name === event.value
                                                                                        );
                                                                                    }
                                                                                );
                                                            ...
                                                            <FieldWrapperAction onBlur={submit}>
                                                                <LabelWrapper label={this.translation['Type']}>
                                                                    <EntitySelect
                                                                        ...
                                                                        value={values.elements[index].type}
                                                                    />
                                                                </LabelWrapper>
                                                            </FieldWrapperAction>
                                                ...
                                                >
                                                    <LabelWrapper
                                                        ...
                                                        tooltip={
                                                            this.translation['Friendly name to be displayed in a tag']
                                                        }
                                                    >
                                                        <StyledFormikField
                                                            type='text'
...
export const BotResponseSetAttribute = I18n(
    withRouter(
