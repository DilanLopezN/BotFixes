...
export class ConversationAttributeConsumerService {
    ...
    constructor(private conversationService: ConversationService, private kafkaService: KafkaService) {}
    ...
    private async startKafkaConsumer() {
        const consumer = await this.kafkaService.getKafkaConsumer({
            consumerGroupId: ConversationAttributeConsumerService.name,
