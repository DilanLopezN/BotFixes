...
export class SetupController {
    constructor(private readonly setupService: SetupService, private readonly setupSetting: SetupSettingService) {}

    @Post('/setup-settings')
    async createSetupStep(@Body() body: CreateSetupSetting) {
        return await this.setupSetting.createSetupSetting(body);
    }

    @Post('/initial-setup')
    async createInitialSetup(@Body() body: CreateInitialSetup) {
