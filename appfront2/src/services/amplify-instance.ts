import { Auth, Cache, Amplify } from 'aws-amplify';
import {
  CognitoUserSession,
  CognitoUser,
...
const credentials = {
  awsRegion: envConstants.COGNITO_REGION,
  awsPoolId: envConstants.COGNITO_POOL_ID,
  awsWebClientId: envConstants.COGNITO_POOL_CLIENT_ID,
};
...
const amplifyConfig = {
  ...
  app_name: 'dasatest',
  oauth: {
    domain: `dasatest.auth.${envConstants.COGNITO_REGION}.amazoncognito.com`,
...
const changePassword = ({
  ...
  new Promise<CognitoUser | any>((resolve, reject) => {
