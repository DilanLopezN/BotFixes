import { ClockCircleOutlined, InfoCircleOutlined, LineChartOutlined } from '@ant-design/icons';
import { Card, Space, Spin, Tooltip, Typography } from 'antd';
import type { MetricCardProps } from './interfaces';

export const MetricCard = ({ title, description, isLoading, icon, tooltip }: MetricCardProps) => {
  const Icon = icon === 'clock' ? ClockCircleOutlined : LineChartOutlined;
