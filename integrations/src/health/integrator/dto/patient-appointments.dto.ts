...
class PatientSchedulesByCpfDto {
  @ApiProperty()
  @ValidateNested()
  @Type(() => PartialPatientByCpfDto)
  patient: PartialPatientByCpfDto;
...
export { PatientSchedulesDto, PatientSchedulesByCpfDto };
